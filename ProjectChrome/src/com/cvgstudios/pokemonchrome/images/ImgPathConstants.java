...
// If its non-abstract + class, it can easily be integrated with the javascript
// stuff.
public abstract interface ImgPathConstants {
	...
	static final String POKEMON_SPRITES_PATH = PIC_FOLDER
			+ "/pokemon";

	static final String POKEMONB_SPRITES_PATH = SPRITES_PATH
			+ "/PokemonB";

	static final String STUCTURES_SPRITES_PATH = SPRITES_PATH
			+ "/Structures";
	...
	static final String BATTLE_SPRITES_PATH = SPRITES_PATH
			+ "/Battle";
	...
	static final String PPICS_MENU_PATH = MENU_PATH
			+ "/PlayerPictures";

	static final String STARTERS_MENU_PATH = MENU_PATH + "/Starters";

	static final String GIRL_NPC_SPRITES_PATH = NPC_SPRITES_PATH
			+ "/Girl";

	static final String GATE_NPC_SPRITES_PATH = NPC_SPRITES_PATH
			+ "/Gate";

	static final String BOY_NPC_SPRITES_PATH = NPC_SPRITES_PATH
			+ "/Boy";

	static final String DAD_NPC_SPRITES_PATH = NPC_SPRITES_PATH
			+ "/Dad";
	...
	static final String SPRITE_ATTACK_PATH = BATTLE_SPRITES_PATH
			+ "/Attacks";
